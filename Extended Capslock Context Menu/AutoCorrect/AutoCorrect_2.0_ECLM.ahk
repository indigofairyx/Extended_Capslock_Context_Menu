...
;original ahk forum= [is listed in the heading below]
...
trayicon = autocorrect_ahkicon.ico
Menu, Tray, Icon, autocorrect_ahkicon.ico

menu, tray, add, ; line -------------------------,
menu, tray, add, Hotkey to Add Auto-Corrections `tWin + H, donothing
menu, tray, icon, Hotkey to Add Auto-Corrections `tWin + H, %trayicon%
